...
$menu_items = [
    ...
    ['label' => 'Ride Scheduler', 'url' => 'ride_scheduler.php', 'rights' => ['rosters']],
    ['label' => 'Tickets', 'url' => 'tickets.php', 'rights' => ['tickets']],
    ['label' => 'Promo Engine', 'url' => 'promo_engine.php', 'rights' => ['tickets']],
    ...
    ['label' => 'Ledger Insights', 'url' => 'ledger_insights.php', 'rights' => ['daily_operations']],
    ['label' => 'Maintenance', 'url' => 'maintenance.php', 'rights' => ['maintenance']],
    ['label' => 'Report a problem', 'url' => 'problem.php', 'rights' => ['report_problem']],
    ['label' => 'Guest Feedback', 'url' => 'guest_feedback.php', 'rights' => ['report_problem']],
    ...
    ['label' => 'Tenant Directory', 'url' => 'tenant_directory.php', 'rights' => ['user_management']],
